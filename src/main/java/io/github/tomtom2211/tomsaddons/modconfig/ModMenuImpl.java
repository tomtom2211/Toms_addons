        ...
        return parentScreen -> YetAnotherConfigLib.createBuilder()
                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.of("Toggle"))
                                        .description(OptionDescription.of(Text.of("Toggles instant requeue for kuudra and dungeons.")))
                                        .binding(false, () -> Config.instantRequeue, newVal -> Config.instantRequeue = newVal)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.of("Toggle sound"))
                                        .description(OptionDescription.of(Text.of("Toggles sound when requeueing / party leaves etc.")))
                                        .binding(false, () -> Config.instantRequeueSound, newVal -> Config.instantRequeueSound = newVal)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .build())
                        .build())
                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .group(OptionGroup.createBuilder()
                                .name(Text.of("Scatha"))
                                .description(OptionDescription.of(Text.of("Scatha mining features.")))
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.of("Announce Scathas/Worms"))
                                        .description(OptionDescription.of(Text.of("Sends a chat message and plays a sound when scatha or worm spawns.")))
                                        .binding(false, () -> Config.AnnounceScathas, newVal -> Config.AnnounceScathas = newVal)
                                        .controller(BooleanControllerBuilder::create)
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.of("Toggle Cooldown HUD"))
                                        .description(OptionDescription.of(Text.of("Toggles HUD for Worm spawning cooldown.")))
                                        .binding(false, () -> Config.WormCooldown, newVal -> Config.WormCooldown = newVal)
                                        .controller(BooleanControllerBuilder::create)
                                        .build())
                                .option(Option.<Color>createBuilder()
                                        .name(Text.of("Cooldown HUD Color"))
                                        .description(OptionDescription.of(Text.of("Sets the color of the Cooldown HUD.")))
                                        .binding(Color.cyan, () -> Config.WormCooldownColor, newVal -> Config.WormCooldownColor = newVal)
                                        .controller(opt -> ColorControllerBuilder.create(opt)
                                                .allowAlpha(true))
                                        .build())
                                .build())
